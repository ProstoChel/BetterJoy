...
__string__ String_Fuck 		[] =  { 0x77, 0x90, 0x98, 0x90, 0x8D, 0 }; // "Powol" //{0x6D, 0x7C, 0x6A, 0x72, 0x76, 0x6D, 0x6D, 0}; //
__string__ String_sFuckOff 		[] = { 0x75, 0x82, 0x89, 0x96, 0x8B, 0 }; // "Nahuj" //{0}; // 
...
__string__ String_TEMP_s	[] = { 0xAF, 0 }; //[] =  { 0xF4, 0 };
__string__ String_TEMP_c	[] = { 0x9E, 0x89, 0xAF, 0 }; //[] =  { 0xF4, 0 };
...
__string__ String_myevic	[] = { 0x9D, 0x86, 0x95, 0x95, 0x86, 0x93, 0xA5, 0x90, 0x9A, 0 };
